...
if (isset($_REQUEST['clear'])) {
    $db->query($db->delete('table.Qcomment'));
}
...
$all = $db->fetchAll($db->select()->from('table.Qcomment')
    ->order('table.Qcomment.time', Typecho_Db::SORT_DESC));

$pageCount = ceil(count($all) / $pageSize);

$current = $db->fetchAll($db->select()->from('table.Qcomment')
        ...
        <div class="row typecho-page-main" role="main">
            <div class="col-mb-12 typecho-list">
                <div class="typecho-list-operate clearfix">
                    <form method="POST"
                          action="<?php $options->adminUrl('extending.php?panel=Qcomment/Logs.php'); ?>">
